"""
Benchmark comparing Fused vs Naive kernels.

Measures the speedup achieved by kernel fusion (reducing memory traffic).
Comparing:
1. Soil Moisture: separate ET/Leakage vs Fused
2. Vegetation: separate Growth/Mortality vs Fused
"""
...
def run_comparison(name: str, fused_func, naive_func, fields, params, steps=1000):
    """Run head-to-head comparison of two kernel versions."""
